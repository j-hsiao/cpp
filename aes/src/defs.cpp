...
namespace
{
	...
	{
		unsigned char data;
		muls(unsigned char v): data(v){}
		unsigned char operator[](std::size_t i) const
		{ return aes::mul(static_cast<unsigned char>(i), data); }
	};
...
namespace aes
{
	...
	{
		static const unsigned char box[256] = {
